...
namespace Google.Apis.Logging
{
    ...
    public sealed class Log4NetLogger : ILogger
    {
        ...
        {
            log.Info(message.FormatString(formatArgs));
        }

        public void Warning(string message, params object[] formatArgs)
        {
            log.Warn(message.FormatString(formatArgs));
        }

        public void Debug(string message, params object[] formatArgs)
        {
            log.Debug(message.FormatString(formatArgs));
        }

        public void Error(Exception exception, string message, params object[] formatArgs)
        {
            log.Error(message.FormatString(formatArgs), exception);
        }

        public void Error(string message, params object[] formatArgs)
        {
            log.Error(message.FormatString(formatArgs));
        }
    }
}
